...
def init(start_ray_local=False, num_workers=None, num_objstores=None, node_ip_address=None, redis_address=None, object_store_name=None, object_store_manager_port=None, local_scheduler_name=None, driver_mode=SCRIPT_MODE):
